...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">Booking</h2>
                                </a>
                                ...
                                <form id="form1" action="{{ route('do_register') }}"  class="auth-register-form mt-2" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <label for="register-firstname" class="form-label">First Name</label>
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="johndoe" aria-describedby="register-username" tabindex="1" autofocus />
                                        {{ $errors->first('first_name') }}
                                    </div>
                                    <div class="mb-1">
                                        <label for="register-lastname" class="form-label">Last Name</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="johndoe" aria-describedby="register-username" tabindex="1" autofocus />
                                    ...
                                    <button type="submit" id="save1" value="add" class="btn btn-primary w-100 add"  tabindex="5">Sign up</button>
                                </form>
    ...
    <!-- BEGIN: Page JS-->
    {{-- <script src="{{ asset('theme/app-assets/js/scripts/pages/auth-register.js') }}"></script> --}}
    <!-- END: Page JS-->
