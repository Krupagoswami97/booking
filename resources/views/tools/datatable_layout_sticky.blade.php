                        ...
                        <tr>
                            <th>
                                <div class="form-check form-check-inline d-flex justify">
                                    ...
                                    <label class="form-check-label" for="parentCheckbox1" style="margin-right: 5px !important;margin-left: 5px !important">No </label>
                                    <i data-feather="trash-2" class="delete "></i>
                                </div>
                                <input type="hidden" id="PermissionUpdate" value="">
                                <input type="hidden" id="PermissionDelete" value="">
                            </th>
                        </tr>
                        <tr class="spinnerTr">
